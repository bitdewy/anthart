...
var dataFromExif = function(exifData) {
  var map = {
    '1': {
  ...
  return map[exifData.image.Orientation];
};
...
var rotate = function(image) {
  if (image.exif) {
    ...
    var imageWidth = image.exif.exif.ExifImageWidth;
    var imageHeight = image.exif.exif.ExifImageHeight;
